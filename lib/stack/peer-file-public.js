define(['opjs/stack/peer', 'opjs/stack/util', 'opjs/cifre/sha256', 'opjs/cifre/utils'],
  function (Peer, util, sha256, cifreUtils) {
  'use strict';
  ...
  PeerFilePublic.prototype._generateContactID = function (sectionA) {
    ...
    contactID = cifreUtils.tohex(sha256(sectionAStr));
    return contactID;
  };
