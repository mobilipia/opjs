define(['opjs/stack/peer', 'opjs/stack/util', 'opjs/cifre/cifre', 'opjs/vendor/sha1'],
  ...
  PeerFilePublic.prototype.getID = function () {};

  PeerFilePublic.prototype.getPeerURI = function () {
    return this._peerURI;
  };

  PeerFilePublic.prototype.getCreated = function () {};
  PeerFilePublic.prototype.getExpires = function () {};
  PeerFilePublic.prototype.getSignedSaltBundle = function () {};
  PeerFilePublic.prototype.getIdentityBundles = function () {};
  PeerFilePublic.prototype.getAssociatedPeerFiles = function () {};
  PeerFilePublic.prototype.getAssociatedPeerFilePrivate = function () {};
  PeerFilePublic.prototype.getPublicKey = function () {};
  PeerFilePublic.prototype.verifySignature = function () {};
  PeerFilePublic.prototype.encrypt = function () {};

  // getFindSecret
  PeerFilePublic.prototype.getFindSecret = function () {
    var sectionB = this.getSection('B');
    var findSecret;

    if (!sectionB) {
      console.warn('PeerFilePublic: Unable to find Section B');
      return '';
    }

    findSecret = sectionB.section && sectionB.section.findSecret;

    if (!findSecret) {
      console.warn('PeerFilePublic: Find secret not found.');
      return '';
    }
    return findSecret;
  };
  ...
  PeerFilePublic.prototype._generateContactID = function (sectionA) {
    ...
    plainText = 'contact:' + util.safeStringify(sectionA);
